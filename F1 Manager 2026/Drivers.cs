...
namespace F1_Manager_2026
{
    public class Drivers
    {
        ...
        public static Drivers Lewis_Hamilton = new Drivers { Name = "Lewis Hamilton", Number = 44, PhotoPath = "/Images/hamilton.png", Skill = 93, Team = "Mercedes" };
        ...
        public static List<Drivers> GetAllDrivers()
        {
            ...
            // ZAČIATOČNÍCKY ŠTÝL: Použitie while cyklu na naplnenie listu
            int index = 0;
